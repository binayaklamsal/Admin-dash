...
const AdminLogin = () => {
  ...
  return (
    <div>
      <section className=" h-screen bg-[#ACAFBD] ">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div className="w-full bg-[#DBDFF0] rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full bg-[#ACAFBD] font-medium rounded-lg text-sm px-5 py-2.5 text-center "
                >
                  Sign in
                </button>
